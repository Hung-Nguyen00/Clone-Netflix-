        ...
        <script type="text/javascript">
              $(document).ready(function () {
                   ...
                   function check_username_ajax(username) {
                        $("#userCheckResult").html('<span class="text-danger"><i class="fa fa-unlink" aria-hidden="true"></i> Connection error<br/></span>');
                        $.post('../../java/controller/CheckEmailServlet.java', {'username': username}, function (data) {
